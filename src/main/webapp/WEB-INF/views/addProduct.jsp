...
<h2>Add New Medicine</h2>
			<form:form action="/admin/product/add" modelAttribute="product" method="post">
				...
				<label for="productName">Medicine Name </label>
					<input type="text" id="productName" name="productName" required>
				
				 <label for="size">mg</label>
				...
				<label for="productCategory" >Medicine Category</label>
				...
				<label for="image_Url">Select Medicine Image </label>
				<!-- select from folder -->
