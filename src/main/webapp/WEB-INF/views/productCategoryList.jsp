...
<title>Medicine Category List</title>
</head>
<body>
<jsp:include page="adminHeader.jsp" />
<div class="container">
	<a href="/admin/categories/add" style="margin: 20px 0" class="btn btn-primary">Add Medicine</a>
	<table class ="table table-striped" border="1" width="100%" >  
		
		<thead class="thead-dark">
		<tr>
		<th>Brand<th>Type</th><th>Category</th><th>Edit</th><th>Delete</th>
		</tr> 
		</thead>
