        ...
        <div class="row">
          ...
          <div class="col-sm-10 sidenav">
            ...
            <div class="list-group list-group-flush list-group-no-border list-group-sm">
              ...
              <a href="/shop/Kids/Kids" class="list-group-item list-group-item-action">Kids(above 6 yrs)</a>
          ...
          <div class="col-sm-10 sidenav">
            ...
            <div class="list-group list-group-flush list-group-no-border list-group-sm">
              ...
              <a href="/shop/brand/Sun Pharma" class="list-group-item list-group-item-action">Sun Pharma</a>
              <a href="/shop/brand/Emcure Pharma" class="list-group-item list-group-item-action">Emcure Pharma</a>
            </div>
          </div> 
           ...
           <div class="col-sm-10 sidenav">
            ...
            <div class="list-group list-group-flush list-group-no-border list-group-sm">
              ...
              <a href="/shop/style/Acidity" class="list-group-item list-group-item-action">Acidity</a>
               <a href="/shop/style/Cramps" class="list-group-item list-group-item-action">Cramps</a>
